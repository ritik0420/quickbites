...
const PlaceOrder = () => {
  ...
  console.log("🔍 Checking localStorage before verification:");
console.log("MongoDB Order ID:", localStorage.getItem("mongo_order_id"));
console.log("Razorpay Order ID:", localStorage.getItem("razorpay_order_id"));
